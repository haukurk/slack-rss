<%@ Page Language="C#" ContentType="text/xml"  AutoEventWireup="true" CodeBehind="RSS.aspx.cs" Inherits="SlackRSSProxy.RSS" ResponseEncoding="UTF-8" 
    
%><?xml version="1.0" encoding="utf-8" ?><asp:Repeater ID="RepeaterRSS" runat="server">
<HeaderTemplate>
<rss version="2.0">
    <channel>
...
<ItemTemplate>
    <item>
        <title><%# RemoveIllegalCharacters(SummarizeText(DataBinder.Eval(Container.DataItem, "text")))%></title>
        <link>http://slack.com</link>
